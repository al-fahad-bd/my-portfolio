...
const App: React.FC = () => {
  ...
  const icons = {
    ...
    devto: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M0 1.146C0 .513.526 0 1.175 0h21.65C23.474 0 24 .513 24 1.146v21.708c0 .633-.526 1.146-1.175 1.146H1.175C.526 24 0 23.487 0 22.854V1.146zm4.863 16.037h5.635a2.332 2.332 0 0 0 2.383-2.384v-2.74a2.332 2.332 0 0 0-2.383-2.383H8.36V6.032H4.863v11.151zm3.497-3.499h1.8a.728.728 0 0 1 .744.744v1.251a.728.728 0 0 1-.744.743h-1.8v-2.738zm10.748-6.064h-2.912l-1.48 4.607-1.48-4.607h-3.32l2.67 7.086v4.065h3.407v-4.065l2.67-7.086z" /></svg>,
    ...
    kaggle: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M18.825 23.859c-.022.092-.117.141-.283.141h-3.139c-.187 0-.351-.082-.493-.248l-5.16-6.158-2.528 2.338v3.69c0 .166-.056.32-.169.462-.112.14-.265.21-.458.21H2.707c-.194 0-.348-.07-.462-.21a.614.614 0 0 1-.168-.462V.61c0-.166.056-.32.168-.462.114-.14.268-.21.462-.21h3.888c.193 0 .346.07.458.21.113.142.169.296.169.462v15.234l7.636-7.854c.14-.15.304-.225.493-.225h3.332c.162 0 .252.052.271.154.018.103-.023.204-.124.304L10.96 15.75l8.118 7.82c.1.092.148.188.148.288zm-3.32-9.155l-1.07-1.026-6.52 6.037v-2.07l7.59-7.05v4.108z" /></svg>
  };
